...
feat.val1 <- function(image,c(x1,y1,x2,y2,x3,y3,x4,y4)){
...
feat.val2 <- function(image,c(x1,y1,x2,y2,x3,y3,x4,y4)){
...
feat.val3 <- function(image,c(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6)){
...
feat.val4 <- function(image,c(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8)){
  white1 <- image[x2,y2]+image[x1-1,y1-1]-image[x2,y1-1]-image[x1-1,y2]
  black1 <- image[x4,y4]+image[x3-1,y3-1]-image[x4,y3-1]-image[x3-1,y4]
  white2 <- image[x6,y6]+image[x5-1,y5-1]-image[x6,y5-1]-image[x5-1,y6]
